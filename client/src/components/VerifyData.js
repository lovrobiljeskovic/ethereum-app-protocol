  ...
  render =() => {
    return (
      <div className="App">
        ...
        <p></p>
        <div className="col-sm-2">
        <Button type="button" className="btn btn-dark btn-sm-2" onClick={this.getSignature}>Get the signature and hashed data</Button>
        <p>SIGNATURE: {this.props.signature}</p>
        <p>HEX DATA: {this.props.hexData}</p>
        <Button type="button" className="btn btn-dark" onClick={this.addressRecovery}>Sign</Button>
...
export default Component(VerifyData);
